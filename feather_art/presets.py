...
PRESETS: dict[str, Preset] = {
    "sketch": Preset("sketch", "速写", 1152, 96, 0.38, 2, "快而轻：小图、表情包、印章"),
    "freehand": Preset("freehand", "写意", 1600, 160, 0.30, 3, "均衡之选：日常插画"),
    "finebrush": Preset("finebrush", "工笔", 3600, 256, 0.24, 4, "精细复刻：细节优先"),
